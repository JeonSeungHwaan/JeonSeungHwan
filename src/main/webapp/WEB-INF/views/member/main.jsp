	      ...
	      <tr > 
	       ...
	       <tr>
	          <td colspan="3" bgcolor="${title_c}"   align="center">
	            ...
	            <input type="button"  value="회원가입" onclick="javascript:window.location='/member/signUp'">
	         </td>
       ...
       <table width=500 cellpadding="0" cellspacing="0"  align="center" border="1" >
         <tr>
           ...
           <td rowspan="3" bgcolor="${value_c}" align="center">
             ...
             <input type="button" value="회원정보변경" onclick="javascript:window.location='/member/modify'">
             </form>
         </td>
        </tr>
       <tr > 
